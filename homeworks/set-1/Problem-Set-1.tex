...
\ProblemItem{$\mathtt{map}\;\;\;\;\colon \Parens{\alpha \rightarrow \beta} \rightarrow \mathtt{List}\;\alpha \rightarrow \mathtt{List}\;\beta$}\\
...
\ProblemItem{$\mathtt{deduplicate}\Parens{ 3 \Cons 1 \Cons 2 \Cons \mathtt{Nil} } = 3 \Cons 1 \Cons 2 \Cons \mathtt{Nil}$}\\[5mm]
